...
import model.Seat;
import model.ShowTime; // Corrected: Use ShowTime (capital T)
// import model.User; // Removed: Not used here
...
public class BookingDAO {
    ...
    private ShowTimeDAO showTimeDAO; // Corrected: Use ShowTimeDAO (capital T)

    public BookingDAO() {
        // DBUtil.initTable() and DBUtil.initData() handle database setup at application start.
        customerDAO = new CustomerDAO();
        showTimeDAO = new ShowTimeDAO(); // Corrected: Use ShowTimeDAO
    }
    ...
    public boolean saveBooking(Booking booking) {
        ...
        Connection conn = null; // Declare connection locally for try-with-resources
        try {
            ...
            try (PreparedStatement bookingStmt = conn.prepareStatement(insertBookingSQL, Statement.RETURN_GENERATED_KEYS)) {
                ...
                bookingStmt.setInt(2, booking.getShowtime().getId()); // Corrected: getShowTime()
